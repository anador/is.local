...
//вынужден использовать такое неудобное и непрактичное решение, поскольку код по условию должен быть легковоспроизводимым, из-за этого не использовал модуль GeoIP, так как тогда при его отсутствии после простого клонирования репозитория код бы не заработал
